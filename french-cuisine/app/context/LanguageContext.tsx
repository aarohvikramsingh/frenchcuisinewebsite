...
const translations = {
  en: {
    ...
    "recipe.bouillabaisse.name": "Bouillabaisse",
    "recipe.creme-brulee.name": "Crème Brûlée",
    "recipe.tarte-tatin.name": "Tarte Tatin",
    "recipe.onion-soup.name": "French Onion Soup",
    "recipe.duck-confit.name": "Duck Confit",
    ...
    "recipe.quiche-lorraine.desc": "A savory tart from Lorraine with bacon, cheese, and creamy egg custard in a flaky pastry shell.",
    "recipe.bouillabaisse.desc": "A traditional Provençal fish stew from Marseille, served with rouille sauce and crusty bread.",
    ...
    "recipe.onion-soup.desc": "Caramelized onions in rich beef broth, topped with toasted bread and melted Gruyère cheese.",
    "recipe.duck-confit.desc": "Duck legs slowly cooked in their own fat until tender, then crisped to perfection.",
    ...
    // Region Descriptions
    "region.provence.desc": "Famous for herbs, olive oil, and fresh Mediterranean flavors. Home to bouillabaisse and ratatouille.",
  ...
  fr: {
    ...
    "recipe.coq-au-vin.ingredient.1": "750ml de vin rouge de Bourgogne",
    "recipe.coq-au-vin.ingredient.2": "200g de lardons fumés",
    "recipe.coq-au-vin.ingredient.3": "250g de champignons de Paris",
    "recipe.coq-au-vin.ingredient.4": "2 oignons jaunes",
    "recipe.coq-au-vin.ingredient.5": "3 gousses d'ail",
    "recipe.coq-au-vin.ingredient.6": "1 bouquet garni",
    "recipe.coq-au-vin.step.0": "Faire mariner le poulet dans le vin avec les aromates pendant 4 heures ou toute la nuit.",
    "recipe.coq-au-vin.step.1": "Retirer le poulet et le faire dorer dans du beurre jusqu'à ce qu'il soit doré.",
    "recipe.coq-au-vin.step.2": "Faire revenir les lardons, les oignons et les champignons séparément.",
    "recipe.coq-au-vin.step.3": "Ajouter le vin de la marinade, le bouquet garni et le poulet.",
    "recipe.coq-au-vin.step.4": "Laisser mijoter doucement pendant 1,5 à 2 heures jusqu'à ce que le poulet soit tendre.",
    // Ratatouille
    "recipe.ratatouille.ingredient.0": "2 courgettes, coupées en dés",
    "recipe.ratatouille.ingredient.1": "1 aubergine, coupée en dés",
    "recipe.ratatouille.ingredient.2": "2 poivrons rouges, coupés en dés",
    "recipe.ratatouille.ingredient.3": "4 tomates mûres, concassées",
    "recipe.ratatouille.ingredient.4": "1 oignon, émincé",
    "recipe.ratatouille.ingredient.5": "4 gousses d'ail, hachées",
    "recipe.ratatouille.ingredient.6": "Herbes de Provence, huile d'olive",
    "recipe.ratatouille.step.0": "Couper tous les légumes en cubes de taille uniforme.",
    "recipe.ratatouille.step.1": "Faire revenir l'oignon et l'ail dans de l'huile d'olive jusqu'à ce qu'ils soient translucides.",
    "recipe.ratatouille.step.2": "Ajouter les poivrons et l'aubergine, cuire pendant 5 minutes.",
    "recipe.ratatouille.step.3": "Ajouter les courgettes et les tomates.",
    "recipe.ratatouille.step.4": "Saupoudrer d'herbes de Provence et laisser mijoter 30 minutes à feu doux.",
    // Croissants
    "recipe.croissants.ingredient.0": "500g de farine",
    "recipe.croissants.ingredient.1": "300g de beurre froid",
    "recipe.croissants.ingredient.2": "50g de sucre",
    "recipe.croissants.ingredient.3": "10g de levure sèche",
    "recipe.croissants.ingredient.4": "250ml de lait tiède",
    "recipe.croissants.ingredient.5": "1 cuillère à café de sel",
    "recipe.croissants.step.0": "Préparer la pâte en mélangeant la farine, le sucre, la levure, le sel et le lait.",
    "recipe.croissants.step.1": "Abaisser le beurre froid en un grand rectangle plat.",
    "recipe.croissants.step.2": "Plier la pâte autour du beurre en trois tours.",
    "recipe.croissants.step.3": "Faire reposer au réfrigérateur entre chaque tour.",
    "recipe.croissants.step.4": "Couper en triangles et rouler en croissants.",
    "recipe.croissants.step.5": "Laisser lever 2 heures puis cuire à 200°C pendant 15-20 minutes.",
    // Quiche Lorraine
    "recipe.quiche-lorraine.ingredient.0": "1 pâte brisée",
    "recipe.quiche-lorraine.ingredient.1": "200g de lardons",
    "recipe.quiche-lorraine.ingredient.2": "200ml de crème épaisse",
    "recipe.quiche-lorraine.ingredient.3": "3 gros œufs",
    "recipe.quiche-lorraine.ingredient.4": "100g de Gruyère râpé",
    "recipe.quiche-lorraine.ingredient.5": "Noix de muscade, poivre noir",
    "recipe.quiche-lorraine.step.0": "Préchauffer le four à 180°C et foncer le moule avec la pâte.",
    "recipe.quiche-lorraine.step.1": "Faire revenir les lardons jusqu'à ce qu'ils soient croustillants.",
    "recipe.quiche-lorraine.step.2": "Battre les œufs avec la crème et la muscade.",
    "recipe.quiche-lorraine.step.3": "Disposer les lardons et le fromage sur le fond de tarte.",
    "recipe.quiche-lorraine.step.4": "Verser l'appareil et cuire 35-40 minutes jusqu'à dorure.",
    // Bouillabaisse
    "recipe.bouillabaisse.ingredient.0": "1kg de poissons variés (rascasse, congre, chapon)",
    "recipe.bouillabaisse.ingredient.1": "500g de moules",
    "recipe.bouillabaisse.ingredient.2": "4 tomates mûres",
    "recipe.bouillabaisse.ingredient.3": "1 oignon, 4 gousses d'ail",
    "recipe.bouillabaisse.ingredient.4": "1 branche de fenouil",
    "recipe.bouillabaisse.ingredient.5": "Huile d'olive, safran, zeste d'orange",
    "recipe.bouillabaisse.step.0": "Préparer le fumet de poisson avec les arêtes et aromates.",
    "recipe.bouillabaisse.step.1": "Faire revenir l'oignon, l'ail et les tomates dans de l'huile d'olive.",
    "recipe.bouillabaisse.step.2": "Ajouter le fumet et le safran.",
    "recipe.bouillabaisse.step.3": "Cuire les poissons selon leur temps de cuisson respectif.",
    "recipe.bouillabaisse.step.4": "Ajouter les moules en dernier et servir avec la rouille.",
    // Crème Brûlée
    "recipe.creme-brulee.ingredient.0": "500ml de crème épaisse",
    "recipe.creme-brulee.ingredient.1": "6 jaunes d'œufs",
    "recipe.creme-brulee.ingredient.2": "100g de sucre",
    "recipe.creme-brulee.ingredient.3": "1 gousse de vanille",
    "recipe.creme-brulee.step.0": "Chauffer la crème avec la vanille jusqu'à frémissement.",
    "recipe.creme-brulee.step.1": "Battre les jaunes et le sucre jusqu'à blanchiment.",
    "recipe.creme-brulee.step.2": "Verser la crème chaude sur les jaunes en remuant.",
    "recipe.creme-brulee.step.3": "Cuire au bain-marie à 150°C pendant 40 minutes.",
    "recipe.creme-brulee.step.4": "Réfrigérer 4 heures, puis caraméliser le sucre sur le dessus.",
    // Tarte Tatin
    ...
    // Onion Soup
    "recipe.onion-soup.ingredient.0": "1kg d'oignons jaunes, émincés",
    "recipe.onion-soup.ingredient.1": "2L de bouillon de bœuf",
    "recipe.onion-soup.ingredient.2": "200ml de vin blanc sec",
    "recipe.onion-soup.ingredient.3": "100g de beurre",
    "recipe.onion-soup.ingredient.4": "8 tranches de baguette",
    "recipe.onion-soup.ingredient.5": "200g de Gruyère râpé",
    "recipe.onion-soup.step.0": "Faire fondre le beurre et faire revenir les oignons à feu moyen pendant 30-40 minutes jusqu'à caramélisation.",
    "recipe.onion-soup.step.1": "Ajouter le vin blanc pour déglacer.",
    "recipe.onion-soup.step.2": "Verser le bouillon et laisser mijoter 20 minutes.",
    "recipe.onion-soup.step.3": "Disposer le pain sur les bols, saupoudrer de fromage.",
    "recipe.onion-soup.step.4": "Gratiner au four jusqu'à ce que le fromage soit doré et bouillonnant.",
    // Duck Confit
    "recipe.duck-confit.ingredient.0": "4 cuisses de canard",
    "recipe.duck-confit.ingredient.1": "1kg de graisse de canard",
    "recipe.duck-confit.ingredient.2": "4 gousses d'ail",
    "recipe.duck-confit.ingredient.3": "4 branches de thym",
    "recipe.duck-confit.ingredient.4": "2 cuillères à soupe de sel",
    "recipe.duck-confit.ingredient.5": "Poivre noir, laurier",
    "recipe.duck-confit.step.0": "Frotter les cuisses avec le sel, le poivre, l'ail et les herbes.",
    "recipe.duck-confit.step.1": "Laisser mariner 24 heures au réfrigérateur.",
    "recipe.duck-confit.step.2": "Rincer et sécher les cuisses.",
    "recipe.duck-confit.step.3": "Cuire dans la graisse de canard fondue à 110°C pendant 2-3 heures.",
    "recipe.duck-confit.step.4": "Laisser refroidir dans la graisse pour conservation.",
    "recipe.duck-confit.step.5": "Pour servir, retirer de la graisse et griller à 200°C pour croustillant.",
    ...
    "recipe.creme-brulee.name": "Crème Brûlée",
    "recipe.tarte-tatin.name": "Tarte Tatin",
    "recipe.onion-soup.name": "Soupe à l'Oignon",
    "recipe.duck-confit.name": "Confit de Canard",
    ...
    "recipe.quiche-lorraine.desc": "Une tarte salée de Lorraine avec du lard, du fromage et une crème d'œufs dans une croûte feuilletée.",
    "recipe.bouillabaisse.desc": "Une soupe de poisson traditionnelle provençale de Marseille, servie avec sauce rouille et pain croustillant.",
    ...
    "recipe.onion-soup.desc": "Oignons caramélisés dans un bouillon de bœuf riche, garnis de pain grillé et de Gruyère fondu.",
    "recipe.duck-confit.desc": "Cuisses de canard cuites lentement dans leur propre graisse jusqu'à tendreté, puis grillées à la perfection.",
    ...
    "region.provence.desc": "Célèbre pour ses herbes, son huile d'olive et ses saveurs méditerranéennes fraîches. Berceau de la bouillabaisse et du ratatouille.",
